                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                新增活動資料
                                <br>
                                <form method="post" action="../../GetAllEvents"><input id="back" type="submit" value="回到上一頁" /></form>
                            </div>
                            </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="post" action="com.ex2.controller/InsertEvent">
                                <table >
                                    <thead>
                                        <tr>
                                            <th>項目</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>活動主題</td>
                                            <td><input type="text" name="eventTopic" /></td>
                                        </tr>
                                        <tr>
                                            <td>活動資訊</td>
                                            <td><input type="text" name="eventInfo" /></td>
                                        </tr>
                                        <tr>
                                            <td>活動日期</td>
                                ...
                                <br>
                                <input id="add" type="submit" value="儲存" onclick="reloadEventTable();"/>
                            </form>
                            </div>
                        </div>
                    </div>
