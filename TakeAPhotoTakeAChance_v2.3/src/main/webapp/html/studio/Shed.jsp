                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                管理攝影棚資料
                                <br>
                                <button id="add"><a href="./html/studio/InsertStudio.jsp">新增攝影棚</a></button>
                        ...
                        <div class="card mb-4">
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/GetAllShed">
                                <table id="datatablesSimple">
								  ...
								  <tbody>
									<c:forEach var="shed" items="${shedList}">
									  <tr>
									    <td>${shed.studioID}</td>
									    <td>${shed.shedName}</td>
									    <td>${shed.shedFee}</td>
									    <td>${shed.shedType}</td>
									    <td><button id="editStudio">編輯</button></td>
									    <td><button id="del" class="delete-btn" data-studio-id="${shed.studioID}">刪除</button></td>
									  </tr>
									</c:forEach>
								  </tbody>
			  ...
			  $(document).ready(function() {
				  $('.delete-btn').on('click', function() {
				    ...
				    if (confirm('確定要刪除此攝影棚工作室？')) {
				      window.location.href = '${pageContext.request.contextPath}/DeleteStudio?studioID=' + studioID;
				    }
				  });
				});
