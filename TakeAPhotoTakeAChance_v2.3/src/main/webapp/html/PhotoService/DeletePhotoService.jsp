                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
								<form method="post" action="/TakeAPhotoTakeAChance/DeletePhotoServiceServlet">
									<table>
										<tr><td>Photo Service ID<td>	<input type="text" readonly name="serviceID" value="${resultBean.serviceID}">
										<tr><td>Photo Service Name<td>	<input type="text" readonly name="serviceName" value="${resultBean.serviceName}">
										<tr><td>Photo Service Type<td>	<input type="text" readonly name="serviceType" value="${resultBean.serviceType}">
										<tr><td>Photo Service Price<td>	<input type="text" readonly name="servicePrice" value="${resultBean.servicePrice}">
										<tr><td>Photo Service Duration<td>	<input type="text" readonly name="serviceDuration" value="${resultBean.serviceDuration}">
										<tr><td>Photo Service Location<td>	<input type="text" readonly name="serviceLocation" value="${resultBean.serviceLocation}">
										<tr><td>Photo Service Creator<td>	<input type="text" readonly name="serviceCreator" value="${resultBean.serviceCreator}">
									</table>
									<hr>
									<p>確定刪除?</p>
