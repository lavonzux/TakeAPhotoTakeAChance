                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
								<table>
									<tr>
										<td>Photo Service ID
										<td><input type="text" disabled value="${resultBean.serviceID}">
									<tr>
										<td>Photo Service Name
										<td><input type="text" disabled
											value="${resultBean.serviceName}">
									<tr>
										<td>Photo Service Type
										<td><input type="text" disabled
											value="${resultBean.serviceType}">
									<tr>
										<td>Photo Service Price
										<td><input type="text" disabled
											value="${resultBean.servicePrice}">
									<tr>
										<td>Photo Service Duration
										<td><input type="text" disabled
											value="${resultBean.serviceDuration}">
									<tr>
										<td>Photo Service Location
										<td><input type="text" disabled
											value="${resultBean.serviceLocation}">
									<tr>
										<td>Photo Service Creator
										<td><input type="text" disabled
											value="${resultBean.serviceCreator}">
								</table>
...
<body style="background-color: #fdf5e6">
	<div align="center">
		...
		<form method="post"
			action="/TakeAPhotoTakeAChance/html/PhotoService/PhotoServiceManager.html">
			<input type="submit" value="回到管理主頁面" />
		</form>
