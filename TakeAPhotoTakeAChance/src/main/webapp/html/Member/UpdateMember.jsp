						...
						<div class="card-body">
							<form action="UpdateMemberServlet" method="post">
								...
								<input type="hidden" id="memberID" name="memberID"
									value="${member.memberID}"> <label for="memberAccount">帳號：</label>
								<input type="text" id="memberAccount" name="memberAccount"
									value="${member.memberAccount}" required><br>
								<br> <label for="memberPassword">密碼：</label> <input
									type="password" id="memberPassword" name="memberPassword"
									value="${member.memberPassword}" required><br>
								<br> <label for="memberEmail">Email：</label> <input
									type="email" id="memberEmail" name="memberEmail"
									value="${member.memberEmail}" required><br>
								<br> <label for="memberName">姓名：</label> <input type="text"
