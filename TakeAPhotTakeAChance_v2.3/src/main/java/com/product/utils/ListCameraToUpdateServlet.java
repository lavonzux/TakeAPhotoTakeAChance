...
@WebServlet("/ListCameraToUpdateServlet")
public class ListCameraToUpdateServlet extends HttpServlet {
...
//            cameraList.get(0)
            ...
            request.getRequestDispatcher("/html/TowaKawaii/UpdateCamera2.jsp").forward(request, response);
