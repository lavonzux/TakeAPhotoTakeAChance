...
@WebServlet("/ListLensToUpdateServlet")
public class ListLensToUpdateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	try {
            ...
            request.getRequestDispatcher("/html/TowaKawaii/UpdateLens2.jsp").forward(request, response);
